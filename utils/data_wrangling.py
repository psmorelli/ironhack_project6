...
def ks_merge_files_fixed_date(input_file,output_file,extract_date,start_date,end_date, deadline):
    ...
    df_kickstarter = df_kickstarter[df_kickstarter["created_at"].ge(start_date) & df_kickstarter["created_at"].le(end_date) & df_kickstarter["deadline"].lt(deadline)]
